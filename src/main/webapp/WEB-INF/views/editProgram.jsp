...
<title>Soft Base - edit Program</title>
	...
	<script type="text/javascript"><%@include file="/script/news.js"%></script>
	...
	<form:form method="post" modelAttribute="program">
		...
		<div>
			What's new in latest version:<br />
				<form:textarea path="newInform" cols="46" rows="9" class="new"/><br />
		...
		<br /><br />
	<a class="design yellow" href="<c:url value='/admin/program/findprog/${program.id}' />">Back To Program Details</a>
	&nbsp; &nbsp; 
